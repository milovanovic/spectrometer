...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------
class NCO_FFT_POUT_SpectrometerTester
(
  ...
  SpectrometerTesterUtils.plot_fft(inputData = chiselFFTForPlot, plotName = "NCO -> FFT -> POUT", fileName = "SpectrometerTest/nco_fft_pout.pdf")
}
