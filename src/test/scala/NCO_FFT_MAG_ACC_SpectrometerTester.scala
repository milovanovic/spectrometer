...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------
class NCO_FFT_MAG_ACC_POUT_SpectrometerTester
(
  ...
  SpectrometerTesterUtils.plot_fft(inputData = chiselFFTForPlot, plotName = "NCO -> FFT -> MAG -> ACC -> POUT", fileName = "SpectrometerTest/nco_fft_mag_acc_pout.pdf")
}
