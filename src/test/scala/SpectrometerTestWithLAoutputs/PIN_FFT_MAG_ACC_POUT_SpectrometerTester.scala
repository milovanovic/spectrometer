...
(
  ...
  val filein = new File("./test_run_dir/SpectrometerTestWithLAoutputs/pin_fft_mag_acc_pout/input.txt")
  ...
  val file = new File("./test_run_dir/SpectrometerTestWithLAoutputs/pin_fft_mag_acc_pout/GoldenData.txt")
