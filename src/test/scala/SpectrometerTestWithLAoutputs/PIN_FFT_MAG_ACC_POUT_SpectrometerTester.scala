...
(
  ...
  val filein = new File("./../top/dv/SpectrometerTestWithLAoutputs/spectrometer/pin_fft_mag_acc_pout/input.txt")
  ...
  SpectrometerTesterUtils.plot_fft(inputData = chiselFFTForPlot, plotName = "PIN -> FFT -> MAG -> ACC -> POUT", fileName = "SpectrometerTestWithLAoutputs/pin_fft_mag_acc_pout/plot.pdf")

  // Write output data to text file
  val file = new File("./../top/dv/SpectrometerTestWithLAoutputs/spectrometer/pin_fft_mag_acc_pout/GoldenData.txt")
