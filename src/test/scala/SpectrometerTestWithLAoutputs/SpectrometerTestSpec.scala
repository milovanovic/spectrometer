...
class SpectrometerTestSpec extends FlatSpec with Matchers {
  ...
  it should "work" in {
    ...
    chisel3.iotesters.Driver.execute(Array("-tiwv", "-tbn", "verilator", "-tivsuv", "--target-dir", "test_run_dir/SpectrometerTestWithLAoutputs/plfg_nco_pout", "--top-name", "SpectrometerTest"), () => lazyDut.module) {
  ...
  it should "work" in {
    ...
    val lazyDut = LazyModule(new SpectrometerTest(params) with SpectrometerTestPins)
    chisel3.iotesters.Driver.execute(Array("-tiwv", "-tbn", "verilator", "-tivsuv", "--target-dir", "test_run_dir/SpectrometerTestWithLAoutputs/plfg_nco_fft_pout", "--top-name", "SpectrometerTest"), () => lazyDut.module) {
  ...
  it should "work" in {
    ...
    val lazyDut = LazyModule(new SpectrometerTest(params) with SpectrometerTestPins)
    chisel3.iotesters.Driver.execute(Array("-tiwv", "-tbn", "verilator", "-tivsuv", "--target-dir", "test_run_dir/SpectrometerTestWithLAoutputs/plfg_nco_fft_mag_pout", "--top-name", "SpectrometerTest"), () => lazyDut.module) {
...
//     val lazyDut = LazyModule(new SpectrometerTest(params) with SpectrometerTestPins)
//     chisel3.iotesters.Driver.execute(Array("-tiwv", "-tbn", "verilator", "-tivsuv", "--target-dir", "test_run_dir/SpectrometerTestWithLAoutputs/PIN_POUT", "--top-name", "SpectrometerTest"), () => lazyDut.module) {
...
//     val lazyDut = LazyModule(new SpectrometerTest(params) with SpectrometerTestPins)
//     chisel3.iotesters.Driver.execute(Array("-tiwv", "-tbn", "verilator", "-tivsuv", "--target-dir", "test_run_dir/SpectrometerTestWithLAoutputs/PIN_FFT_POUT", "--top-name", "SpectrometerTest"), () => lazyDut.module) {
...
//     val lazyDut = LazyModule(new SpectrometerTest(params) with SpectrometerTestPins)
//     chisel3.iotesters.Driver.execute(Array("-tiwv", "-tbn", "verilator", "-tivsuv", "--target-dir", "test_run_dir/SpectrometerTestWithLAoutputs/PIN_FFT_MAG_POUT", "--top-name", "SpectrometerTest"), () => lazyDut.module) {
