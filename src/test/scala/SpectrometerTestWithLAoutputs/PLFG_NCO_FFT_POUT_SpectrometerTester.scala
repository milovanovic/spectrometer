...
(
  ...
  SpectrometerTesterUtils.plot_fft(inputData = chiselFFTForPlot, plotName = "PLFG -> NCO -> FFT -> POUT", fileName = "SpectrometerTestWithLAoutputs/plfg_nco_fft_pout/data.pdf")

  // Write output data to text file
  val file = new File("./test_run_dir/SpectrometerTestWithLAoutputs/plfg_nco_fft_pout/data.txt")
