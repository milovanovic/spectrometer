...
(
  ...
  // Plot input data
  SpectrometerTesterUtils.plot_data(inputData = inData, plotName = "inData", fileName = "SpectrometerTestWithLAoutputs/pin_pout_inData.pdf")

  // Plot output data
  SpectrometerTesterUtils.plot_data(inputData = outputSeq, plotName = "PIN -> POUT", fileName = "SpectrometerTestWithLAoutputs/pin_pout.pdf")
