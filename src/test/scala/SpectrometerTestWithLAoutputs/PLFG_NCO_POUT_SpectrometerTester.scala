...
(
  ...
  SpectrometerTesterUtils.plot_data(inputData = realSeq.map(c => c.toInt), plotName = "PLFG -> NCO -> POUT (COS)", fileName = "SpectrometerTestWithLAoutputs/plfg_nco_pout/plot_cos.pdf")
  SpectrometerTesterUtils.plot_data(inputData = imagSeq.map(c => c.toInt), plotName = "PLFG -> NCO -> POUT (SIN)", fileName = "SpectrometerTestWithLAoutputs/plfg_nco_pout/plot_sin.pdf")

  // Write output data to text file
  val file = new File("./test_run_dir/SpectrometerTestWithLAoutputs/plfg_nco_pout/data_cos.txt")
  ...
  // Write output data to text file
  val file1 = new File("./test_run_dir/SpectrometerTestWithLAoutputs/plfg_nco_pout/data_sin.txt")
