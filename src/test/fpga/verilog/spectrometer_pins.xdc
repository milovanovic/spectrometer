...
## Switches
set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33} [get_ports out_ready]
set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS33} [get_ports in_valid]
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33} [get_ports in_last]
#set_property -dict { PACKAGE_PIN M5    IOSTANDARD SSTL135 } [get_ports io_fft_enable]; #IO_L6N_T0_VREF_34 Sch=sw[3]
...
#set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { btn[1] }]; #IO_L19P_T3_A22_15 Sch=btn[1] // button for up and down
...
## PMOD Header JC
set_property -dict {PACKAGE_PIN U15 IOSTANDARD LVCMOS33} [get_ports {out_data[0]}]
set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} [get_ports {out_data[1]}]
set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports {out_data[2]}]
set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports {out_data[3]}]
set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports {out_data[4]}]
set_property -dict {PACKAGE_PIN P13 IOSTANDARD LVCMOS33} [get_ports {out_data[5]}]
set_property -dict {PACKAGE_PIN R13 IOSTANDARD LVCMOS33} [get_ports {out_data[6]}]
set_property -dict {PACKAGE_PIN V14 IOSTANDARD LVCMOS33} [get_ports {out_data[7]}]

## PMOD Header JD
#set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports {out_data[8]}]
#set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports {out_data[9]}]
#set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports {out_data[10]}]
#set_property -dict {PACKAGE_PIN T12 IOSTANDARD LVCMOS33} [get_ports {out_data[11]}]
#set_property -dict {PACKAGE_PIN T13 IOSTANDARD LVCMOS33} [get_ports {out_data[12]}]
#set_property -dict {PACKAGE_PIN R11 IOSTANDARD LVCMOS33} [get_ports {out_data[13]}]
#set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports {out_data[14]}]
#set_property -dict {PACKAGE_PIN U11 IOSTANDARD LVCMOS33} [get_ports {out_data[15]}]

## USB-UART Interface
set_property -dict {PACKAGE_PIN R12 IOSTANDARD LVCMOS33} [get_ports uTx]
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports uRx]

## USB-UART Interface
#set_property -dict {PACKAGE_PIN R12 IOSTANDARD LVCMOS33} [get_ports {out_data[16]}]
#set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports {out_data[17]}]

## ChipKit Outer Digital Header
#set_property -dict {PACKAGE_PIN L13 IOSTANDARD LVCMOS33} [get_ports {out_data[18]}]
#set_property -dict {PACKAGE_PIN N13 IOSTANDARD LVCMOS33} [get_ports {out_data[19]}]
#set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports {out_data[20]}]
#set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports {out_data[21]}]
#set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports {out_data[22]}]
#set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} [get_ports {out_data[23]}]
#set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports {out_data[24]}]
#set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports {out_data[25]}]
#set_property -dict {PACKAGE_PIN R15 IOSTANDARD LVCMOS33} [get_ports {out_data[26]}]
#set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports {out_data[27]}]
...
#set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33} [get_ports {out_data[28]}]
#set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports {out_data[29]}]
#set_property -dict {PACKAGE_PIN K14 IOSTANDARD LVCMOS33} [get_ports {out_data[30]}]
#set_property -dict {PACKAGE_PIN G16 IOSTANDARD LVCMOS33} [get_ports {out_data[31]}]

## set_property -dict {PACKAGE_PIN G16 IOSTANDARD LVCMOS33} [get_ports {io_out_real[15]}]
