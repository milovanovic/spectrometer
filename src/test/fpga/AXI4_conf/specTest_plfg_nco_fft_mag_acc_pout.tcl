...
create_hw_axi_txn write_txn4 [get_hw_axis hw_axi_1] -type WRITE -address 30005120 -len 1 -data {00000000}
...
create_hw_axi_txn write_txn8 [get_hw_axis hw_axi_1] -type WRITE -address 30005110 -len 1 -data {00000000}
run_hw_axi [get_hw_axi_txns write_txn8]
# configure outMuxAddress
create_hw_axi_txn write_txn9 [get_hw_axis hw_axi_1] -type WRITE -address 30008000 -len 1 -data {00000000}
