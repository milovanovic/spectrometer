...
create_hw_axi_txn write_txn1 [get_hw_axis hw_axi_1] -type WRITE -address 30002220 -len 1 -data {00000000}
...
create_hw_axi_txn write_txn3 [get_hw_axis hw_axi_1] -type WRITE -address 30004124 -len 1 -data {00000000}
run_hw_axi [get_hw_axi_txns write_txn3]

#configure plfgMuxAddress0
create_hw_axi_txn write_txn4 [get_hw_axis hw_axi_1] -type WRITE -address 30002210 -len 1 -data {00000000}
run_hw_axi [get_hw_axi_txns write_txn4]
#configure ncoMuxAddress0
create_hw_axi_txn write_txn5 [get_hw_axis hw_axi_1] -type WRITE -address 30003110 -len 1 -data {00000000}
...
# configure plfg 
create_hw_axi_txn write_txn8 [get_hw_axis hw_axi_1] -type WRITE -address 30001000 -len 1 -data {24000000}
run_hw_axi [get_hw_axi_txns write_txn8]

# configure number of frames
create_hw_axi_txn write_txn9 [get_hw_axis hw_axi_1] -type WRITE -address 30002108 -len 1 -data {00000004}
...
create_hw_axi_txn write_txn12 [get_hw_axis hw_axi_1] -type WRITE -address 30002118 -len 1 -data {00000001}
run_hw_axi [get_hw_axi_txns write_txn12]
# configure number of repeated chirps
create_hw_axi_txn write_txn13 [get_hw_axis hw_axi_1] -type WRITE -address 30002128 -len 1 -data {00000001}
run_hw_axi [get_hw_axi_txns write_txn13]
# chip ordinal
create_hw_axi_txn write_txn14 [get_hw_axis hw_axi_1] -type WRITE -address 30002148 -len 1 -data {00000000} 
