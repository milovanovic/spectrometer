...
create_hw_axi_txn write_txn9 [get_hw_axis hw_axi_1] -type WRITE -address 30002220 -len 1 -data {00000000}
run_hw_axi [get_hw_axi_txns write_txn9]
#configure ncoMuxAddress1
create_hw_axi_txn write_txn10 [get_hw_axis hw_axi_1] -type WRITE -address 30003124 -len 1 -data {00000000}
run_hw_axi [get_hw_axi_txns write_txn10]

#configure plfgMuxAddress0
create_hw_axi_txn write_txn11 [get_hw_axis hw_axi_1] -type WRITE -address 30002210 -len 1 -data {00000000}
run_hw_axi [get_hw_axi_txns write_txn11]
#configure ncoMuxAddress0
create_hw_axi_txn write_txn12 [get_hw_axis hw_axi_1] -type WRITE -address 30003114 -len 1 -data {00000000}
run_hw_axi [get_hw_axi_txns write_txn12]
#configure outMuxAddress
create_hw_axi_txn write_txn13 [get_hw_axis hw_axi_1] -type WRITE -address 30008000 -len 1 -data {00000003}
