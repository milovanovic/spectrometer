...
# configure plfg 
create_hw_axi_txn write_txn2 [get_hw_axis hw_axi_1] -type WRITE -address 30001000 -len 1 -data {24000000}
run_hw_axi [get_hw_axi_txns write_txn2]

# configure number of frames
create_hw_axi_txn write_txn3 [get_hw_axis hw_axi_1] -type WRITE -address 30002108 -len 1 -data {00000004}
run_hw_axi [get_hw_axi_txns write_txn3]
# configure number of chirps 30002100
create_hw_axi_txn write_txn4 [get_hw_axis hw_axi_1] -type WRITE -address 30002110 -len 1 -data {00000001}
run_hw_axi [get_hw_axi_txns write_txn4]
# configure start value - set to 16!
create_hw_axi_txn write_txn5 [get_hw_axis hw_axi_1] -type WRITE -address 30002114 -len 1 -data {00000010}
run_hw_axi [get_hw_axi_txns write_txn5]
# configure number of segments for first chirp
create_hw_axi_txn write_txn6 [get_hw_axis hw_axi_1] -type WRITE -address 30002118 -len 1 -data {00000001}
run_hw_axi [get_hw_axi_txns write_txn6]
# configure number of repeated chirps
create_hw_axi_txn write_txn7 [get_hw_axis hw_axi_1] -type WRITE -address 30002128 -len 1 -data {00000001}
run_hw_axi [get_hw_axi_txns write_txn7]
# chip ordinal
create_hw_axi_txn write_txn8 [get_hw_axis hw_axi_1] -type WRITE -address 30002148 -len 1 -data {00000000} 
run_hw_axi [get_hw_axi_txns write_txn8]
# set reset bit to zero
create_hw_axi_txn write_txn9 [get_hw_axis hw_axi_1] -type WRITE -address 30002100 -len 1 -data {00000001} 
...
# memWriteWord(params.outMuxAddress.base + 0x4, 0x0) // output1                              // enable bit becomes 1
