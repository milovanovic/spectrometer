...
create_hw_axi_txn write_txn2 [get_hw_axis hw_axi_1] -type WRITE -address 30002220 -len 1 -data {00000000}
run_hw_axi [get_hw_axi_txns write_txn2]
#configure ncoMuxAddress1
create_hw_axi_txn write_txn3 [get_hw_axis hw_axi_1] -type WRITE -address 30003120 -len 1 -data {00000000}
run_hw_axi [get_hw_axi_txns write_txn3]
#configure fftMuxAddress1
create_hw_axi_txn write_txn4 [get_hw_axis hw_axi_1] -type WRITE -address 30004120 -len 1 -data {00000000}
run_hw_axi [get_hw_axi_txns write_txn4]
#configure magMuxAddress1
create_hw_axi_txn write_txn5 [get_hw_axis hw_axi_1] -type WRITE -address 30005124 -len 1 -data {00000000}
run_hw_axi [get_hw_axi_txns write_txn5]
# configure plfgMuxAddress0
create_hw_axi_txn write_txn6 [get_hw_axis hw_axi_1] -type WRITE -address 30002210 -len 1 -data {00000000}
run_hw_axi [get_hw_axi_txns write_txn6]
# configure ncoMuxAddress0
create_hw_axi_txn write_txn7 [get_hw_axis hw_axi_1] -type WRITE -address 30003110 -len 1 -data {00000000}
run_hw_axi [get_hw_axi_txns write_txn7]
# configure fftMuxAddress0
create_hw_axi_txn write_txn8 [get_hw_axis hw_axi_1] -type WRITE -address 30004110 -len 1 -data {00000000}
run_hw_axi [get_hw_axi_txns write_txn8]
#configure magMuxAddress0
create_hw_axi_txn write_txn9 [get_hw_axis hw_axi_1] -type WRITE -address 30005114 -len 1 -data {00000000}
run_hw_axi [get_hw_axi_txns write_txn9]

#configure outMuxAddress -> send to TX line
...
# configure plfg 
create_hw_axi_txn write_txn11 [get_hw_axis hw_axi_1] -type WRITE -address 30001000 -len 1 -data {24000000}
run_hw_axi [get_hw_axi_txns write_txn11]

# configure number of frames
create_hw_axi_txn write_txn12 [get_hw_axis hw_axi_1] -type WRITE -address 30002108 -len 1 -data {00000004}
run_hw_axi [get_hw_axi_txns write_txn12]
# configure number of chirps 30002100
create_hw_axi_txn write_txn13 [get_hw_axis hw_axi_1] -type WRITE -address 30002110 -len 1 -data {00000001}
run_hw_axi [get_hw_axi_txns write_txn13]
# configure start value - set to 16 - 10!
create_hw_axi_txn write_txn14 [get_hw_axis hw_axi_1] -type WRITE -address 30002114 -len 1 -data {00000010}
run_hw_axi [get_hw_axi_txns write_txn14]
# configure number of segments for first chirp
create_hw_axi_txn write_txn15 [get_hw_axis hw_axi_1] -type WRITE -address 30002118 -len 1 -data {00000001}
run_hw_axi [get_hw_axi_txns write_txn15]
# configure number of repeated chirps
create_hw_axi_txn write_txn16 [get_hw_axis hw_axi_1] -type WRITE -address 30002128 -len 1 -data {00000001}
run_hw_axi [get_hw_axi_txns write_txn16]
# chip ordinal
create_hw_axi_txn write_txn17 [get_hw_axis hw_axi_1] -type WRITE -address 30002148 -len 1 -data {00000000} 
run_hw_axi [get_hw_axi_txns write_txn17]
# set reset bit to zero
create_hw_axi_txn write_txn18 [get_hw_axis hw_axi_1] -type WRITE -address 30002100 -len 1 -data {00000001} 
run_hw_axi [get_hw_axi_txns write_txn18]

# configure divisor int - 868 -> 0364! 869 ->0365
create_hw_axi_txn write_txn19 [get_hw_axis hw_axi_1] -type WRITE -address 30009018 -len 1 -data {00000364}  
run_hw_axi [get_hw_axi_txns write_txn19]

# configure UART TX - enable TX
create_hw_axi_txn write_txn20 [get_hw_axis hw_axi_1] -type WRITE -address 30009008 -len 1 -data {00000001} 
